...
* Wed May 06 2020 Kevin Buettner <kevinb@redhat.com> - 9.1-5
- Fix build breakage when compiling bfd/elf.c with gcc 10. (RHBZ 1818011,
  H.J. Lu)

* Mon Mar  2 2020 Sergio Durigan Junior <sergiodj@fedoraproject.org> - 9.1-4
- Add '--without-guile' to GDB_MINIMAL_CONFIGURE_FLAGS (RHBZ 1801144).
