...
- Fix 'Paths for breakpoints are not resolved' (Tom Tromey, RHBZ
  1785768).  This is actually a reversion of the commit that caused
  the bug.

* Tue Feb  4 2020 Sergio Durigan Junior <sergiodj@redhat.com> - 8.3.50.20190824-28
- Fix for "gdb segfaults if working directory was deleted" (Sergio
  Durigan Junior, RHBZ 1728147).

* Tue Jan 14 2020 Dan Čermák <dan.cermak@cgc-instruments.com> - 8.3.50.20190824-27
- Re-enable guile support

* Mon Jan  6 2020 Sergio Durigan Junior <sergiodj@fedoraproject.org> - 8.3.50.20190824-26
- Fix 'Paths for breakpoints are not resolved' (RHBZ 1785768).

* Thu Nov 21 2019 Sergio Durigan Junior <sergiodj@redhat.com> - 8.3.50.20190824-25
